...
namespace GeekBurger.StoreCatalogs.Application.ProductChangedEvents
{
    public class ProductChangedSubscriber
    {
        private readonly ISubscriptionClient _subscriptionClient;

        public ProductChangedSubscriber(string serviceBusConnectionString, string topicName, string subscriptionName)
        {
